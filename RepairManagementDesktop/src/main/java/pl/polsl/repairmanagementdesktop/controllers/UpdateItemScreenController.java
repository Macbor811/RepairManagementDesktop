...
@Scope("prototype")
@Controller
public class UpdateItemScreenController {
    ...
    @Autowired
    public UpdateItemScreenController(LoaderFactory fxmlLoaderFactory, ItemTypeService itemTypeService, ItemService itemService, CustomerService customerService) {
